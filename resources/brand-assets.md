...
* **Bitcoin orange**: `#F7931A` (light mode accent), `#FFA533` (dark mode accent).
* **Parchment**: `#F5F1E8` (light mode background).
* **Navy**: `#0B1220` (dark mode background).
* **Ink**: `#1A1A1A` (light mode body text).
* **Bone**: `#E8E6E0` (dark mode body text).
