...
<Warning>
**Pre-mainnet. Targeting Q3 2026.** The protocol is in active development. See the [Roadmap](/learn/roadmap).
</Warning>

## Choose your path

<CardGroup cols={3}>
  <Card title="BTC holder" icon="bitcoin" href="/learn/what-is-qbtc">
    Plain-English explanations of what QBTC is, why the quantum threat matters, and what your claim will look like.
  </Card>
  <Card title="Developer" icon="code" href="/build/overview">
    Architecture, consensus, claim mechanism, APIs, and how to run a node.
  </Card>
  <Card title="Researcher / Institution" icon="flask" href="/research/overview">
