...
* **You will use a quantum-safe wallet.** An established Bitcoin wallet partner is implementing native post-quantum signing (ML-DSA) and QBTC claim-proof generation, with rollout planned at mainnet. The partner will be named ahead of launch. Claiming will be a normal in-wallet action.
