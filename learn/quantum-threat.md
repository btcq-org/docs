...
* **Post-quantum signatures are large.** ML-DSA signatures are roughly 2.5 KB, vs. roughly 70 bytes for ECDSA. Even with aggregation, this is a significant load on Bitcoin's block space.
